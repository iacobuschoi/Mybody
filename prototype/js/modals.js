    ...
    UI.openModal({
      ...
      body: [
        ...
        h('ul', { style: { paddingLeft: '18px', fontSize: '13px', color: 'var(--text-2)' } }, [
          ...
          h('li', { text: '로그인하면 측정값이 내가 지정한 서버로 올라갑니다. 친구에게 무엇이 보일지는 친구마다 따로 켜야 하고, 기본으로 켜진 것은 행동에 대한 둘입니다 — 이번 주에 기록했는지, 그리고 계획한 날과 지킨 날의 개수.' })
        ]),
      ...
      if (mode === 'up') {
        ...
        body.appendChild(h('div.note.note--warn', { style: { marginTop: '12px' } }, [
          ...
          h('ul', { style: { paddingLeft: '18px', margin: '8px 0 0', fontSize: '13px' } }, [
            ...
            h('li', { text: '얼마나 — 최근 52주까지만. 그보다 오래된 주는 서버가 지웁니다. ' +
