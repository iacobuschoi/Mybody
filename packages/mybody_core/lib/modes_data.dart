...
/// 측정 노이즈 바닥 (근거 문장까지 그대로).
const Map<String, Object?> kNoise = {
  'weight': 1.0,
  'smm': 0.6,
  'bfm': 1.0,
...
const List<Object?> kModes = [
  {
    ...
    'aMax': 0.9,
    'strategy': 'auto',
    'proteinPerFfmMin': 2.2,
    'proteinPerFfmMax': 2.8,
    'typicalWeeksMin': 8.0,
    'typicalWeeksMax': 20.0,
    'maxContinuousWeeks': 20.0,
  ...
  },
  {
    ...
    'proteinPerFfmMin': 2.4,
    'proteinPerFfmMax': 3.1,
    'typicalWeeksMin': 8.0,
    'typicalWeeksMax': 20.0,
    'maxContinuousWeeks': 12.0,
  ...
  },
  {
    ...
    'proteinPerFfmMin': 2.4,
    'proteinPerFfmMax': 2.8,
    'typicalWeeksMin': 16.0,
    'typicalWeeksMax': 36.0,
    'maxContinuousWeeks': 24.0,
  ...
  },
  {
    ...
    'aMax': 0.75,
    'strategy': 'auto',
    'proteinPerFfmMin': 1.9,
    'proteinPerFfmMax': 2.4,
    'typicalWeeksMin': 12.0,
    'typicalWeeksMax': 24.0,
    'maxContinuousWeeks': 32.0,
  ...
  },
  {
    ...
    'aMax': 0.08,
    'strategy': 'simultaneous',
    'proteinPerFfmMin': 1.6,
    'proteinPerFfmMax': 2.0,
    'typicalWeeksMin': 4.0,
    'typicalWeeksMax': 12.0,
  ...
  },
  {
    ...
    'aMax': 1.0,
    'strategy': 'simultaneous',
    'proteinPerFfmMin': 2.6,
    'proteinPerFfmMax': 3.1,
    'typicalWeeksMin': 3.0,
    'typicalWeeksMax': 5.0,
    'maxContinuousWeeks': 6.0,
...
/// 거부 규칙 — 문구와 판정식 원문. 순서가 곧 심각도입니다.
const List<Object?> kRefusals = [
  {
    ...
    'source': '[\'curWeightKg\',\'curSmmKg\',\'curBfmKg\',\'heightCm\',\'age\',\'dWeightKg\',\'dSmmKg\',\'dBfmKg\'].some(function(f){ return input[f] == null || !isFinite(input[f]); }) || (sex !== \'male\' && sex !== \'female\')',
  },
  {
    ...
    'source': 'age < 19 && (dWeightKg < -NOISE.weight || dBfmKg < -NOISE.bfm)',
  },
  {
    ...
    'source': '(sex === \'male\' ? (curPbfPct < 15 && targetPbfPct < 10) : (curPbfPct < 23 && targetPbfPct < 18)) && dWeightKg < -0.05 * curWeightKg',
  },
  {
    ...
    'source': 'targetPbfPct < (sex === \'male\' ? 8 : 15)',
  },
  {
    ...
    'source': 'curBmi < 18.5 || targetBmi < 18.5',
  },
  {
    ...
    'source': 'Math.abs(dWeightKg - (dBfmKg + dSmmKg / k)) > 1.5',
  },
  {
  ...
  },
  {
    ...
    'source': 'dBfmKg >= NOISE.bfm && Math.abs(dSmmKg) <= NOISE.smm',
  },
  {
    ...
    'source': 'deadlineWeeks !== null && deadlineWeeks > 0 && (Math.abs(dWeightKg) / curWeightKg) / deadlineWeeks > 0.015',
  },
  {
    'message': '목표 기간이 4주 미만입니다. 인바디로 확인 가능한 변화가 나오는 최소 단위가 4주라서, 그보다 짧은 계획은 만들어도 진행 여부를 판정할 수 없습니다.',
    'source': 'deadlineWeeks !== null && deadlineWeeks < 4',
  },
];

/// 선택 규칙 — 순서·모드·이유·판정식 원문.
const List<Object?> kRules = [
  {
    'order': 1.0,
    'modeId': 'recovery',
