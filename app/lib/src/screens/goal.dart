 ...
 * 어느 길이든 끝은 같은 강도 화면(intensity.dart)입니다. 강도 화면이 여섯 달을
 * 넘는 계획 앞에서 「기간으로 정하기」를 권하고 사용자가 그걸 고르면, 그 답을
 * 들고 여기로 돌아와 기간 모드로 바뀝니다.
 * ========================================================================== */
...
class _GoalScreenState extends State<GoalScreen> {
  ...
  /* 두 갈래. 몸의 숫자를 먼저 정하는 원래 길과, 기간을 먼저 정하고 그 안에
     ...
     섭니다 — 계획을 세우면 강도 화면이 두 번 pop 하는데, 그 두 번이 이 화면과
     셸 사이에 딱 맞아야 합니다. */
  Widget _chooser() {
    return Padding(
