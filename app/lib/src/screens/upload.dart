  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: ListView(padding: const EdgeInsets.all(16), children: [
        ...
        /* **없는 기능을 설명하지 않습니다.**
         *
         * 여기에는 원래 "사진은 이 기기에만 남습니다. 자동 판독은 설정에서
         * 켤 때만 돕니다" 가 적혀 있었습니다. 웹 앱에서 그대로 옮겨 온
         * 문장인데, 이 앱에는 **사진을 넣을 데가 없습니다.** 결과지 사진과
         * 자동 판독은 카메라·갤러리 플러그인이 필요해서 아직 안 옮겼습니다.
         *
         * 그 문장을 읽은 사람은 사진 넣는 버튼을 찾다가 못 찾습니다.
         * 없는 것은 없다고 적습니다. */
        Text(
          '결과지 사진 넣기와 자동 판독은 아직 이 앱에 없습니다 — 숫자는 손으로 '
          '넣어 주세요. 넣은 숫자는 이 기기에만 남습니다.',
